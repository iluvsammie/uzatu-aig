const translations = {
  kk: {
    ...
    'invite-greeting':      'ҚҰРМЕТТІ<br>АҒАЙЫН-ТУЫС, БАУЫРЛАР,<br>ҚҰДА-ЖЕКЖАТ, НАҒАШЫ-ЖИЕН,<br>ҚҰРБЫ-ҚҰРДАС, ӘПКЕ-ЖЕЗДЕЛЕР,<br>ДОС-ЖАРАНДАР, ӘРІПТЕСТЕР,<br>КӨРШІЛЕР!',
    ...
    'event-city':           'ТАРАЗ ҚАЛАСЫ, ТӨЛЕ БИ ДАҢҒЫЛЫ, 93А',
    'event-map-btn':        '📍 2GIS-те ашу',
    'countdown-h2':         'Тойға дейін',
    'rest': '«BRONZE» мейрамханасы',
    'timer-days':           'КҮН',
    'timer-hours':          'САҒАТ',
    'timer-minutes':        'МИНУТ',
  ...
  ru: {
    ...
    'invite-main':          ' <br> БУДЕМ СЧАСТЛИВЫ ВИДЕТЬ ВАС<br>СРЕДИ ПОЧЁТНЫХ ГОСТЕЙ<br>И ВМЕСТЕ С НАМИ ПРОВЕСТИ<br> ЭТОТ СВЕТЛЫЙ И НЕЗАБЫВАЕМЫЙ ВЕЧЕР!',
    'story-subtitle':       'ХОЗЯЕВА ТОРЖЕСТВА',
    ...
    'event-city':           'ГОРОД ТАРАЗ, ПРОСПЕКТ ТОЛЕ БИ 93А',
    'event-map-btn':        '📍 Открыть в 2GIS',
    'countdown-h2':         'До торжества',
        'rest': 'РЕСТОРАН «BRONZE»',
